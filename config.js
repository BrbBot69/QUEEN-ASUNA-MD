...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "INCONNU~XD~DhIS2J7Y#fKkbbJLz0Go9SFEPuZ9UDhdTQRXe-HCRUjzkuPEvHsw",
AUTO_STATUS_SEEN: process.env.AUTO_STATUS_SEEN || "true",
AUTO_STATUS_REPLY: process.env.AUTO_STATUS_REPLY || "false",
AUTO_STATUS_REACT: process.env.AUTO_STATUS_REACT || "true",
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY QUEEN-SUNA-MD 🤍*",
...
STICKER_NAME: process.env.STICKER_NAME || "QUEEN-SUNA-MD",
...
LIVE_MSG: process.env.LIVE_MSG || ">*QUEEN-SUNA-MD* 👸 ALIVE",
